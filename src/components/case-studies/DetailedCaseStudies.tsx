  ...
  return (
    <div className="bg-card rounded-2xl border border-border overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <div className="p-6 md:p-8">
        ...
        <h3 className="font-serif text-2xl font-bold text-foreground mb-2">{study.title}</h3>
      ...
      {isExpanded && (
        <div className="px-6 md:px-8 pb-8 border-t border-border pt-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed italic">{study.learnings}</p>
          </div>
        </div>
      )}
    </div>
