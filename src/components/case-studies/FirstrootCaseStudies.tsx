    ...
    >
      ...
      {isExpanded && (
        <div className="px-6 md:px-8 pb-8 border-t border-border pt-6 space-y-6 animate-fade-in">
          {/* Full Title */}
          <div className="p-4 bg-gradient-to-r from-accent to-background rounded-xl">
            <p className="text-xs text-muted-foreground uppercase tracking-wide mb-1">Full Case Study</p>
            <p className="text-foreground font-medium">{study.title}</p>
          </div>
          ...
          <div className="p-4 bg-primary/5 border border-primary/20 rounded-xl">
            <p className="text-xs text-primary uppercase tracking-wide mb-1">Goal / Success Metric</p>
            <p className="text-foreground text-sm">{study.goal}</p>
          </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="font-semibold text-foreground">Solutions Implemented</h4>
            </div>
            <ul className="space-y-2">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="font-semibold text-foreground">What I Would Do Next</h4>
            </div>
            <ul className="space-y-2">
          ...
          <div className="p-6 border-2 border-dashed border-border rounded-xl text-center">
            ...
            <p className="text-xs text-muted-foreground mt-1">Detailed slides with visuals and data</p>
          </div>
        </div>
      )}
    </div>
